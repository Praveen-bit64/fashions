...
const Footer = () => {
    const commanClasses = {
        reachUs: "relative  after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-1/2 after:h-[2px] after:bg-emerald-500 text-slate-900",
        categories: "relative text-md font-delius-swash-caps after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-1/2 hover:after:h-[2px] after:bg-emerald-500 cursor-pointer text-slate-800"
    }
    return (
        <footer className="w-full h-full min-h-2xl bg-slate-100 grid grid-cols-12 py-5">
            <div className="xl:col-span-4 lg:col-span-6 col-span-12 p-4 flex flex-col gap-6 justify-start items-start lg:px-16 px-4">
                ...
                <p className="text-md font-delius-swash-caps text-slate-800"><span className={commanClasses.reachUs + " font-bold"}>Email:</span> fashion@gmail.com</p>
                <p className="text-md font-delius-swash-caps text-slate-800"><span className={commanClasses.reachUs + " font-bold"}>Phone:</span> +91 9876543210</p>
                <p className="text-md font-delius-swash-caps text-slate-800 "><span className={commanClasses.reachUs + " font-bold"}>Address:</span> 123, Main Street, Anytown, USA</p>
                <div className="">
                ...
                <h2 className="text-4xl font-bold font-courgette py-4 text-slate-900">Fashion</h2>
            ...
            <div className="xl:col-span-4 lg:col-span-6 col-span-12 p-4 flex flex-col gap-6 justify-start items-start px-8">
                ...
                <p className="text-md font-delius-swash-caps text-slate-800">Receive our weekly newsletter.
                    For dietary content, fashion insider and the best offers.</p>
                <input type="email" placeholder="Enter your email" className="w-full h-16 border-2 border-slate-300 p-2.5 outline-none text-slate-800" required />
                ...
                <p className="text-md font-delius-swash-caps text-center mt-4 font-bold text-slate-800">{`© ${new Date().getFullYear()} Fashion. All rights reserved.`}</p>
            </div>
        </footer>
    );
}
